...
/// removed.
@immutable
class SelectAll extends ChartBehavior<common.SelectNearest> {
  ...
  factory SelectAll(
    ...
    return new SelectAll._internal(
        ...
        desiredGestures: SelectAll._getDesiredGestures(eventTrigger),
